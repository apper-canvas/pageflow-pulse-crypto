...
function RightSidebar() {
  ...
  return (
<div className="w-80 bg-white fixed right-0 top-0 h-screen shadow-lg rounded-l-xl overflow-y-auto">
...
<div key={author.Id} className="flex items-center justify-between group py-2">
              <div className="flex items-center space-x-3 flex-1">
                ...
                <Button
                  ...
                  className="ml-3 text-xs px-3 py-1 flex-shrink-0 rounded-xl"
                >
...
<div key={blog.Id} className="flex items-start space-x-3 group cursor-pointer hover:bg-gray-50 -mx-2 px-2 py-3 rounded-xl transition-colors">
